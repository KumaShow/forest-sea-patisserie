...
-->
<template>
  <section class="Product container py-11">
    <div class="row">
      <!-- 側邊產品類別選單 -->
      <AsideProductMenu class="col-md-3" />
      <!-- 單一產品內容 -->
      <main class="col-md-9">
        <div class="row border-bottom border-2 pb-10 mb-10">
          <!-- 產品圖片 -->
          <div class="col-6">
            <div>
              <img
          ...
          <!-- 產品介紹 -->
          <div class="col-6">
            <h2 class="fs-4 mb-8 font-serif">{{ product.title }}</h2>
            ...
            <ul>
              <li class="d-flex align-items-center mb-7">
                ...
                <button class="btn btn-outline-gray-500 hover-text-white me-6">
                  5 吋
                </button>
